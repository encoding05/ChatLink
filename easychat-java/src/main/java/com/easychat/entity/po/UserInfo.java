...
public class UserInfo implements Serializable {
	...
	/**
	 *@ Description:申请好友 0：直接加入 1：同意后加好友
	 */
	...
	public Integer getOnlineType() {
		if (lastOffTime != null && lastLoginTime.getTime() > lastOffTime) {
			return 1;
		} else
			return 0;
	}
